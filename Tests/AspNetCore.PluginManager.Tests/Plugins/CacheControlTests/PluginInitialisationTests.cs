...
namespace AspNetCore.PluginManager.Tests.Plugins.CacheControlTests
{
    [TestClass]
    [ExcludeFromCodeCoverage]
    public class PluginInitialisationTests
    {
        private const string TestsCategory = "CacheControl General Tests";
