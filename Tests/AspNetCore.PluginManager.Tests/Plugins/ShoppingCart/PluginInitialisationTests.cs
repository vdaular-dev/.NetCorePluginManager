...
using ShoppingCartPlugin;

namespace AspNetCore.PluginManager.Tests.Plugins.ShoppingCartTests
{
    [TestClass]
    [ExcludeFromCodeCoverage]
    public class PluginInitialisationTests
    {
        private const string TestsCategory = "ShoppingCartPlugin General Tests";
